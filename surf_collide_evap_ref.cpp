...
void SurfCollideEvapRef::diffuse(Particle::OnePart *p, double *norm)
{
...
void SurfCollideEvapRef::wrapper(Particle::OnePart *p, double *norm,
...
void SurfCollideEvapRef::flags_and_coeffs(int *flags, double *coeffs)
{
  if (tmode != NUMERIC)
